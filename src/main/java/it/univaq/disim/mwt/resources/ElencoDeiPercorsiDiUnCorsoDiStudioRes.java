...
public class ElencoDeiPercorsiDiUnCorsoDiStudioRes {
    ...
    public Response getElencoDeiPercorsiDiUnCorsoDiStudio(@PathParam("cds_id") String cds_id, @PathParam("aa_ord_id") String aa_ord_id, @QueryParam("lingua_iso6392_cod") String lingua_iso6392_cod) {
