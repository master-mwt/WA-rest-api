...
public class RegoleDiPercorsoAmbitiDisciplinariRes {
    ...
    public Response getRegoleDiPercorsoAmbitiDisciplinari(@PathParam("cds_id") int cds_id, @PathParam("aa_ord_id") int aa_ord_id, @PathParam("pds_id") int pds_id, @PathParam("prof_cod") int prof_cod, @PathParam("aa_reg_id") int aa_reg_id, @QueryParam("lingua_iso6392_cod") String lingua_iso6392_cod) {
