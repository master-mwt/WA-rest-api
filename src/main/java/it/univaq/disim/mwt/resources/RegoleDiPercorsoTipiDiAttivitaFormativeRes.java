...
public class RegoleDiPercorsoTipiDiAttivitaFormativeRes {
    ...
    public Response getRegoleDiPercorsoTipiDiAttivitaFormativeRes(@PathParam("cds_id") String cds_id, @PathParam("aa_ord_id") String aa_ord_id, @PathParam("pds_id") String pds_id, @PathParam("prof_cod") String prof_cod, @PathParam("aa_reg_id") String aa_reg_id, @QueryParam("lingua_iso6392_cod") String lingua_iso6392_cod) {
